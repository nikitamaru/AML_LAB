function idealPopupPosition(e, t, a, n) {
    var i, r, s = window.innerWidth,
        o = window.innerHeight,
        l = t.offset();
    l && (r = l.top - $(window).scrollTop(), i = l.left - $(window).scrollLeft());
    var c, d, u = t.width(),
        g = t.height(),
        m = 0;
    d = i <= 1 * s / 3 ? 1 : i <= 2 * s / 3 ? 2 : 3, c = r <= o / 2 ? 1 : 2, 1 == c ? m = 1 == d ? 1 : 2 == d ? 2 : 3 : 2 == c && (m = 1 == d ? 4 : 2 == d ? 5 : 6);
    var f, p, y = [];
    return 1 == m ? f = i : 2 == m ? f = s / 2 - a / 2 : 3 == m ? f = i + u - a : 4 == m ? f = i : 5 == m ? f = s / 2 - a / 2 : 6 == m && (f = i + u - a), 1 == m || 2 == m || 3 == m ? (p = r + g, y["y-side"] = "top", y["y-elem"] = r + g) : (p = r - n, y["y-side"] = "bottom", y["y-elem"] = r), y.x = f, y.y = p, y["x-half-elem"] = i + u / 2, y
}

function urlFromFile(e) {
    var t;
    return window.createObjectURL ? t = window.createObjectURL(e) : window.createBlobURL ? t = window.createBlobURL(e) : window.URL && window.URL.createObjectURL ? t = window.URL.createObjectURL(e) : window.webkitURL && window.webkitURL.createObjectURL && (t = window.webkitURL.createObjectURL(e)), t
}

function SelectText(e) {
    var t, a, n = document,
        i = n.getElementById(e);
    n.body.createTextRange ? (t = document.body.createTextRange(), t.moveToElementText(i), t.select()) : window.getSelection && (a = window.getSelection(), t = document.createRange(), t.selectNodeContents(i), a.removeAllRanges(), a.addRange(t))
}
...
function toggleMainMenu() {
    ...
    e.is(":visible") ? (e.animate({
        ...
        e.fadeOut(0), $("#mobile_wrapper").fadeIn(200)
    }), $("#app-section").animate({
        marginLeft: 0
    }, t)) : ($("#mobile_wrapper").fadeOut(200), e.css({
        left: a
    }), e.fadeIn(0), e.animate({
        left: 0
    }, t))
}
...
function openTopSearch() {
    $("#logo_container, #top_user_part").fadeOut(300, function() {
        $("#top_search_icon .icon_show").hide(), $("#top_search_icon .icon_hide").show(), $("#top_search_part").css("width", "82%"), $("#top_search_elements").fadeIn(300)
    })
}

function closeTopSearch() {
    $("#top_search_elements").fadeOut(300, function() {
        $("#top_search_icon .icon_hide").hide(), $("#top_search_icon .icon_show").show(), $("#top_search_part").css("width", "auto"), $("#logo_container, #top_user_part").fadeIn(300)
    })
}
...
function loadImageRain(e) {
    ...
    if (!l && !c) {
        var u = t.attr("data-device-width-percent"),
            g = (t.attr("data-device-type"), window.screen.width);
        if (u) l = g * u / 100;
        else {
            var l = $(e).width();
            l < 10 && (l = 360)
    ...
    l = Math.min(l, 1200), $.ajax({
        ...
        success: function(e) {
            if (e.success) {
                ...
                $.each(c, function() {
                    r.attr(this.name, this.value)
                }), s && (r.is(":visible") || r.show(), s.fadeIn(700)), t.remove()
            }
        },
        error: function(e, t) {
            processError(e, t, !1)
...
function initiateSliding(e) {
    nextSlide(e), setInterval(function() {
        nextSlide(e)
    }, 5e3)
}
...
function slideEntity(e) {
    ...
    i.style.backgroundColor = "#158EC6", r.style.color = "#FFF";
    var o = t.firstChild;
    s.appendChild(o), t.appendChild(n), t.style.opacity = "0.6", fadeInSlide(t, 300)
}
...
function clearPreviewFormat(e) {
    for (var t = 1; t <= 5; t++) {
        ...
        a.style.background = "transparent", n.style.color = "#158EC6"
    }
}
...
function nextSlide(e) {
    var t = document.getElementById("selected_sliding_" + e),
        a = parseInt(t.getAttribute("data-seq-id"));
    a < 5 ? a += 1 : a = 1, t.setAttribute("data-seq-id", a), slideEntity(e)
}

function previousSlide(e) {
    var t = document.getElementById("selected_sliding_" + e),
        a = parseInt(t.getAttribute("data-seq-id"));
    a > 1 ? a -= 1 : a = 5, t.setAttribute("data-seq-id", a), slideEntity(e)
}
...
function fadeInSlide(e, t, a) {
    var n = 15,
        ...
        s = setInterval(function() {
            i >= 1 ? clearInterval(s) : (i += r, e.style.opacity = i)
        }, n)
}
...
function resizeImageContainers() {
    ...
    e.height(.51 * e.width()), $(".square_img_cont").each(function() {
        var e = $(this);
        e.height(e.width())
    })
}
...
function expandShortenWall(e) {
    var t = document.getElementById("entity_wall_image"),
        a = t.height;
    t.width;
    "false" == e.getAttribute("data-expanded") ? (e.style.height = a + "px", e.setAttribute("data-expanded", "true")) : (e.style.height = "20vw", e.setAttribute("data-expanded", "false"))
}

function filterGenre(e) {
    var t = e.options[e.selectedIndex].text,
        a = e.getAttribute("data-uri");
    t && "(None)" != t && (a += "/genre/" + t), window.location.href = a
}
...
function loadMoreEntity(e) {
    ...
    l && (l.style.display = "block"), $.ajax({
        ...
        cache: "false",
        success: function(t) {
            if (l && (l.style.display = "none"), t.success) {
                var a = e.getAttribute("data-container"),
                    n = document.getElementById(a),
                    r = document.getElementById("load_more_" + i + "_box");
                r && r.parentNode.removeChild(r);
                var s = document.createElement("div");
                s.innerHTML = t.view, n.appendChild(s), "notification" != i && scrollToElem(s, "slow", -200), window.setTimeout(function() {
                    $("#load_more_" + i).attr("data-autoload", 1)
                }, 1e3), evaluateLRCMemberScripts(), evaluateReadMoreScripts()
            } else alert("Server side error - " + t.message), t.staff_message && addStaffError(t.staff_message)
        },
        failure: function() {
            l && (l.style.display = "none"), alert("Error! Please try again.")
        }
    })
}
...
function searchLRC(e, t, a) {
    $.ajax({
        ...
        cache: "false",
        success: function(e) {
            e.success && (a.innerHTML = e.view, evaluateLRCMemberScripts(), evaluateReadMoreScripts())
        },
        error: function(e, t) {
            processError(e, t, !1)
        }
...
function togglePlaylist() {
    ...
    "none" == e.style.display ? (e.style.display = "inline-block", e.style.height = "400px", t.style.width = "450px", t.style.boxShadow = "1px 2px 2px 4px #444444") : (e.style.display = "none", e.style.height = "0px", t.style.width = "173px", t.style.boxShadow = "")
}
...
function loadMusicianMembers(e) {
    ...
    e.innerHTML = '<img src="/images/loading_song_interaction.gif"style="margin:5px;width:30px;" />', $.ajax({
        type: "GET",
        ...
        success: function(t, a, n) {
            t.success ? e.innerHTML = t.view : (alert(t.message), e.innerHTML = "Error while loading!")
        },
        failure: function() {
...
function respectEntity(elem) {
    ...
    elem.src = respectSrc, counter.innerText = eval(counter.innerText) + 1, elem.parentNode.children[1] && (elem.parentNode.children[1].innerText = "Unrespect"), $.ajax({
        type: "POST",
        ...
        success: function(data) {
            data.success ? (elem.setAttribute("alt", elem.getAttribute("alt").replace("Respect", "Unrespect")), elem.onclick = function() {
                unrespectEntity(elem)
            }) : (elem.src = unrespectSrc, eval(counter.innerText) > 0 && (counter.innerText = eval(counter.innerText) - 1), elem.parentNode.children[1] && (elem.parentNode.children[1].innerText = "Respect"), alert(data.message), data.staff_message && addStaffError(data.staff_message))
        },
        error: function(jqXHR, exception) {
            elem.src = unrespectSrc, eval(counter.innerText) > 0 && (counter.innerText = eval(counter.innerText) - 1), elem.parentNode.children[1] && (elem.parentNode.children[1].innerText = "Respect"), processError(jqXHR, exception, !1)
        }
    })
}
...
function unrespectEntity(elem) {
    ...
    elem.src = unrespectSrc, eval(counter.innerText) > 0 && (counter.innerText = eval(counter.innerText) - 1), elem.parentNode.children[1] && (elem.parentNode.children[1].innerText = "Respect"), $.ajax({
        type: "POST",
        ...
        cache: "false",
        success: function(data) {
            data.success ? (elem.setAttribute("alt", elem.getAttribute("alt").replace("Unrespect", "Respect")), elem.onclick = function() {
                respectEntity(elem)
            }) : (elem.src = respectSrc, counter.innerText = eval(counter.innerText) + 1, elem.parentNode.children[1] && (elem.parentNode.children[1].innerText = "Unrespect"), alert(data.message), data.staff_message && addStaffError(data.staff_message))
        },
        error: function(jqXHR, exception) {
            elem.src = respectSrc, counter.innerText = eval(counter.innerText) + 1, elem.parentNode.children[1] && (elem.parentNode.children[1].innerText = "Unrespect"), processError(jqXHR, exception, !1)
        }
    })
}
...
function loadPreview(e, t, a) {
    var n = e.offset();
    n && (elemY = n.top - $(window).scrollTop(), elemX = n.left - $(window).scrollLeft());
    ...
    l.css({
        ...
        success: function(e) {
            if (e.success) {
                o.html(e.view);
                var n = o.height();
                (n < a.y || n > a.y) && (t.y = t.y + a.y - n), o.css({
                    position: "fixed",
                    top: t.y + "px",
                    left: t.x + "px",
                    width: a.width,
                ...
                "top" == t["y-side"] ? (i = t["y-elem"] - 4, s.addClass("upside_down_image")) : (i = t["y-elem"] - 8, s.removeClass("upside_down_image")), r = t["x-half-elem"] - 12, s.css({
                    position: "fixed",
                    top: i + "px",
                    left: r + "px"
                }), l.fadeOut(1e3), o.fadeIn(300), s.fadeIn(300)
            }
        },
        error: function(e, t) {
            l.fadeOut(1e3), processError(e, t, !1)
        }
    })
}

function hidePreview() {
    $("#entity_widget_preview").fadeOut(200), $("#entity_preview_arrow").fadeOut(200)
}
...
function highlightRatingLevel(e) {
    var t = e.getAttribute("data-level"),
        ...
        n = 100 * t / 5;
    a.style.backgroundColor = "#158EC6", a.style.width = n + "%"
}

function resetRatingLevel(e) {
    var t = (e.getAttribute("data-level"), e.parentNode.parentNode.firstElementChild),
        a = t.getAttribute("data-percent");
    t.style.backgroundColor = "#EBD65E", t.style.width = a + "%"
}
...
function fadeIn(e, t) {
    ...
    var i = setInterval(function() {
        n >= 1 ? clearInterval(i) : (n += opUnit, e.style.opacity = n)
    }, a)
}
...
function evaluateJPlayerScripts() {
    for (var jplayerIds = document.getElementsByClassName("jp-jplayer-ajax"), i = 0; i < jplayerIds.length; i++)
        if (1 != jplayerIds[i].getAttribute("data-evaluated")) {
            ...
            eval(script.innerHTML), jplayerIds[i].setAttribute("data-evaluated", 1)
        }
}

function evaluateYoutubeScripts() {
    for (var scripts = document.getElementsByClassName("youtube_player_script"), i = 0; i < scripts.length; i++) scripts[i] && 1 != scripts[i].getAttribute("data-evaluated") && (eval(scripts[i].innerHTML), scripts[i].setAttribute("data-evaluated", 1))
}
...
function evaluateAllOtherScripts() {
    for (var scripts = document.getElementsByClassName("news_feed_adsense"), i = 0; i < scripts.length; i++) 1 != scripts[i].getAttribute("data-evaluated") && (eval(scripts[i].innerHTML), scripts[i].setAttribute("data-evaluated", 1))
}
...
function processError(e, t, a) {
    a && (0 === e.status ? alert("Not connect.\n Verify Network.") : 404 == e.status ? alert("Requested page not found. [404]") : 500 == e.status ? alert("Internal Server Error [500].") : "parsererror" === t ? alert("Requested JSON parse failed.") : "timeout" === t ? alert("Time out error.") : "abort" === t ? alert("Ajax request aborted.") : alert("Uncaught Error!")), addStaffError(e.responseText)
}

function clearSelected(e) {
    for (var t = e.options, a = 0; a < t.length; a++) t[a].selected = !1
}
...
function fireEvent(e, t) {
    ...
    if (e.dispatchEvent) {
        ...
        i.initEvent(t, !0, !0), i.synthetic = !0, e.dispatchEvent(i, !0)
    } else if (e.fireEvent) {
        var i = a.createEventObject();
        i.synthetic = !0, e.fireEvent("on" + t, i)
    }
}

function setMenuEvents() {
    for (var e = document.querySelectorAll(".a_level_1"), t = 0; t < e.length; t++) e[t].onmouseover = function() {
        showMenuLevel2(this)
    }, e[t].onmouseout = function() {
        autoCloseMenuLevel2(this)
    };
    for (var a = document.querySelectorAll(".ul_level_2"), t = 0; t < a.length; t++) a[t].onmouseover = function() {
...
function showMenuLevel2(e) {
    cancelMenuCloseTimer(), lastLink && hideMenuLevel2(lastLink), lastLink = e;
    var t = e.parentNode.getElementsByTagName("ul")[0];
    t && (t.style.opacity = .6, t.style.display = "block", fadeIn(t, 200))
}
...
function cancelMenuCloseTimer() {
    null != menuCloseTimer && (window.clearTimeout(menuCloseTimer), menuCloseTimer = null)
}
    ...
    return n.length < 3 ? void alert("You must type at least 3 characters!") : void $.ajax({
        ...
        success: function(e) {
            if (e.success) {
                ...
                a.innerHTML = e.view
            } else alert("Server side error - " + e.message), e.staff_message && addStaffError(e.staff_message)
        },
        error: function(e, t) {
            processError(e, t, !1)
        }
    ...
    if (a) {
        ...
        if (!r.is(":visible"))
            for (var s = document.getElementsByClassName("header_toggle"), o = 0; o < s.length; o++)
                if (s[o].id != e.id) {
                    var l = $("#" + s[o].id + "_body");
                    l && l.hide(700), s[o].firstElementChild.className = "";
                    var c = document.getElementById(s[o].id + "_up_arrow");
                    c.style.display = "none"
                } r.toggle(700, function() {
            if ($(this).is(":visible")) {
                if (i.className = "header_toggle_active_image", n.style.opacity = .6, t.style.display = "block", a.style.display = "block", fadeIn(n, 200), "header_notification" == e.id) {
                    var r = document.getElementById("notification_counter");
                    refreshNotifications(), updateNoticed(r)
                    ...
                    refreshFriendRequests(), updateFriendRequestChecked(o), refreshFriendSuggestions()
                }
            } else t.style.display = "none", a.style.display = "none", i.className = ""
        })
    }
}
...
function updateNoticed(e) {
    $.ajax({
        ...
        cache: "false",
        success: function(t) {
            t.success ? (e.innerHTML = 0, e.style.display = "none") : t.staff_message && addStaffError(t.staff_message)
        },
        failure: function() {
    ...
    $.ajax({
        ...
        success: function(e) {
            if (e.success) {
                ...
                e.notifCount > 0 ? (e.notifCount > t.innerHTML && playNotificationAudio("/sounds/notification.wav"), t.innerHTML = e.notifCount, t.style.display = "block") : (t.innerHTML = 0, t.style.display = "none")
            }
        },
        failure: function() {
            alert("Error! Please try again.")
...
function refreshNotifications() {
    ...
    container = document.getElementById("list_notification_container"), $(container).append(e), $.ajax({
        type: "GET",
        ...
        cache: "false",
        success: function(t) {
            e.remove(), t.success && (container.innerHTML = t.view)
        },
        error: function(t, a) {
            e.remove(), processError(t, a, !1)
        }
    })
}
...
function playNotificationAudio(e) {
    ...
    t.innerHTML = '<source src="' + e + '" />', t.play()
}
...
function setNotificationAsRead(e) {
    ...
    "unread" == a && $.ajax({
        ...
        success: function(t) {
            if (t.success) {
                var a = e.className;
                a = a.replace("unread", "read"), e.className = a, e.setAttribute("data-read-val", "read")
            }
        },
        failure: function() {
            alert("Error! Please try again.")
    ...
    $.ajax({
        ...
        success: function(e) {
            if (e.success) {
                ...
                a.innerHTML = "", n.innerHTML = e.message, n.style.display = "block"
...
function updateFriendRequestChecked(e) {
    $.ajax({
        ...
        success: function(e) {
            ...
            e.success && (t.innerHTML = 0, t.style.display = "none")
        },
        failure: function() {
...
function checkUncheckedFriendRequests() {
    $.ajax({
        ...
        success: function(e) {
            if (e.success) {
                var t = document.getElementById("friend_counter");
                e.frCount > 0 ? (e.frCount > t.innerHTML && playNotificationAudio("/sounds/notification.wav"), t.innerHTML = e.frCount, t.style.display = "block") : (t.innerHTML = 0, t.style.display = "none")
            }
        },
        failure: function() {
            alert("Error! Please try again.")
...
function refreshFriendRequests() {
    ...
    $(t).append(e), $.ajax({
        ...
        cache: "false",
        success: function(a) {
            e.remove(), a.success && t && (t.innerHTML = a.view)
        },
        error: function(t, a) {
            e.remove(), processError(t, a, !1)
        }
...
function respectSocial(elem) {
    ...
    elem.src = "/images/respected_tiny_emoticon.png", counter.innerText = eval(counter.innerText) + 1, $.ajax({
        type: "POST",
        url: "/user/respect-entity",
        data: {
            EntityId: entityId,
        ...
        cache: "false",
        success: function(data) {
            data.success ? "Comment" == entity ? (elem.setAttribute("title", elem.getAttribute("data-unrespect-title")), elem.setAttribute("alt", elem.getAttribute("data-unrespect-title")), elem.onclick = function() {
                unrespectSocial(elem)
            }) : loadAmplifyableInfo(elem) : (elem.src = "/images/unrespected_tiny_emoticon_bright.png", eval(counter.innerText) > 0 && (counter.innerText = eval(counter.innerText) - 1), alert(data.message))
        },
        error: function(jqXHR, exception) {
            elem.src = "/images/unrespected_tiny_emoticon_bright.png", eval(counter.innerText) > 0 && (counter.innerText = eval(counter.innerText) - 1), processError(jqXHR, exception, !1)
        }
    })
}
...
function unrespectSocial(elem) {
    var entityId = elem.getAttribute("data-entity-id"),
        ...
        counterCont = elem.getAttribute("data-counter-container"),
        counter = document.getElementById(counterCont + "_respect_count");
    elem.src = "/images/unrespected_tiny_emoticon_bright.png", eval(counter.innerText) > 0 && (counter.innerText = eval(counter.innerText) - 1), $.ajax({
        type: "POST",
        url: "/user/unrespect-entity",
        data: {
            EntityId: entityId,
        ...
        success: function(data) {
            data.success ? "Comment" == entity ? (elem.setAttribute("title", elem.getAttribute("data-respect-title")),
                elem.setAttribute("alt", elem.getAttribute("data-respect-title")), elem.onclick = function() {
                    respectSocial(elem)
                }) : loadAmplifyableInfo(elem) : (elem.src = "/images/respected_tiny_emoticon.png", counter.innerText = eval(counter.innerText) + 1, alert(data.message))
        },
        error: function(jqXHR, exception) {
            elem.src = "/images/respected_tiny_emoticon.png", counter.innerText = eval(counter.innerText) + 1, processError(jqXHR, exception, !1)
        }
    })
}
...
function submitAmplification(e) {
    ...
    d && d.checked && (url = "/post/entity/store", c = 1);
    var u = $("#" + s + "_amplify");
    u.hide();
    var g = $("#" + s + "_amplify_loading");
    g.hide(), g.html('<img src="/images/equalizer_loading.gif" style="height:18px;" />'), g.fadeIn(700), $.ajax({
        type: "POST",
        url: url,
        data: {
            postable_type: a,
        ...
        cache: "false",
        success: function(t) {
            if (g.html(""), u.fadeIn(700), t.success) {
                var a = document.getElementById(s + "_amplify_box");
                a.style.display = "none", loadAmplifyableInfo(e, !0)
            } else alert("Server side error - " + t.message), t.staff_message && addStaffError(t.staff_message)
        },
        failure: function() {
            g.html(""), u.fadeIn(700), alert("Failure! Please try again.")
        },
        error: function(e, t) {
            g.html(""), u.fadeIn(700), processError(e, t, !0)
        }
    })
}
...
function loadAmplifyableInfo(e, t) {
    ...
    if (e.getAttribute("data-parent-container")) var i = e.getAttribute("data-parent-container");
    else if (e.getAttribute("data-container")) var i = e.getAttribute("data-container");
    ...
    $.ajax({
        ...
        success: function(e) {
            if (e.success) {
                if (r.innerHTML = e.view, t) {
                    var a = $("#" + i + "_amplify_box_message");
                    a.fadeIn(1e3), window.setTimeout(function() {
                        a.fadeOut(1e3)
                    }, 5e3)
                }
            } else alert(e.message), e.staff_message && addStaffError(e.staff_message)
        },
        error: function(e, t) {
            processError(e, t, !1)
        }
...
function toggleAmplifyBox(e) {
    var t = (e.getAttribute("data-entity-id"), e.getAttribute("data-entity"), e.getAttribute("data-parent-container")),
        a = document.getElementById(t + "_amplify_details"),
        n = $("#" + t + "_amplify_box");
    n.is(":visible") ? (a.setAttribute("contenteditable", !1), n.fadeOut(700)) : n.fadeIn(700, function() {
...
function reverseImage(e) {
    ...
    if ("collapsed" == n) {
        ...
        i.className = "upside_down_image", a.animate({
            "max-height": "1000px"
        ...
        var i = e.firstElementChild;
        i.className = "", a.animate({
            height: "400px"
        }, 1e3, "easeInQuint", function() {
            a.css("max-height", "400px"), a.css("height", "auto"), a.attr("data-status", "collapsed")
        })
    }
}
...
function loadPosts(e) {
    ...
    var i = "recent";
    if (e.getAttribute("data-sort")) var i = e.getAttribute("data-sort");
    ...
    l && (l.style.display = "block"), $.ajax({
        ...
        cache: "false",
        success: function(e) {
            if (l && (l.style.display = "none"), e.success) {
                var t = document.getElementById("list_entity_container"),
                    a = document.getElementById("load_more_" + o + "_box");
                a && a.parentNode.removeChild(a);
                var n = document.createElement("div");
                n.innerHTML = e.view, t.appendChild(n), scrollToElem(n, "slow", -300), window.setTimeout(function() {
                    $("#load_more_post").attr("data-autoload", 1)
                }, 1e3), evaluateJPlayerScripts(), evaluateReadMoreScripts(), evaluateAllOtherScripts(), runImageRequesterScripts(), evaluateYoutubeScripts()
            } else alert("Server side error - " + e.message), e.staff_message && addStaffError(e.staff_message)
        },
        failure: function() {
            l.style.display = "none", alert("Error! Please try again.")
        }
    })
}
...
function loadPost(e) {
    var t = e.getAttribute("data-entity-id"),
        a = $("#post_" + t);
    a.html('<img src="/images/equalizer_loading.gif" style="height:15px;" />'), $.ajax({
        type: "GET",
        url: "/post/" + t,
        cache: "false",
        success: function(e) {
            if (a.html(""), e.success) {
                ...
                t.innerHTML = e.view, a.parentNode.replaceChild(t.firstElementChild, a), evaluateJPlayerScripts(), evaluateReadMoreScripts(), runImageRequesterScripts(), evaluateYoutubeScripts()
            } else alert("Server side error - " + e.message), e.staff_message && addStaffError(e.staff_message)
        },
        error: function(e, a) {
            loading.html('<center><a data-entity-id="' + t + '" onclick="loadPost(this)" >Reload Post</a></center>'), processError(e, a)
        }
    })
}
...
function editPost(e) {
    ...
    n.is(":visible") ? (n.hide(300), t.show(300), a.style.display = "block") : (a.style.display = "none", t.hide(300), n.show(300))
}
...
function updatePost(e) {
    ...
    i.hide(200), r.html('<img src="/images/equalizer_loading.gif" style="height:18px;" />'), n.length > 0 && $.ajax({
        type: "POST",
        url: "/post/" + t + "/update",
        data: {
            details: n,
        ...
        success: function(e) {
            if (r.html(""), e.success) {
                ...
                n.innerHTML = e.view, a.parentNode.replaceChild(n.firstElementChild, a), evaluateJPlayerScripts(), evaluateReadMoreScripts(), runImageRequesterScripts()
            } else alert("Server side error - " + e.message), e.staff_message && addStaffError(e.staff_message)
        },
        failure: function() {
            r.html(""), i.show(200), alert("Failure! Please try again.")
        },
        error: function(e, t) {
            r.html(""), i.show(200), processError(e, t, !0)
        }
    })
}
    ...
    $.ajax({
        ...
        success: function(e) {
            e.success ? $("#post_" + t).fadeOut(500, function() {
                $(this).remove()
            }) : (alert("Server side error - " + e.message), e.staff_message && addStaffError(e.staff_message))
        },
        error: function(e, t) {
            loading.html(""), updateLink.show(200), processError(e, t, !0)
        }
    })
}
...
function autoFindComment(e, t) {
    var a = e + "_comment_" + t,
        n = document.getElementById(a);
    n.style.backgroundColor = "#EEF", scrollTo(n.id, -150)
}
...
function loadJPlayerSongMedia(e, t) {
    $.ajax({
        ...
        success: function(e) {
            if (e.success) {
                var a = e.medias;
                a = JSON && JSON.parse(a) || $.parseJSON(a), "function" == typeof t && t(a)
            }
        },
        error: function(e, t) {
            processError(e, t, !1)
...
function checkPlaying(e) {
    var t = e.attr("id");
    window[t + "_checking"] && window.clearInterval(window[t + "_checking"]), window[t + "_checking"] = window.setInterval(function() {
        e.data().jPlayer.status.currentTime > 0 ? sendPlayingRequest(e) : (clearPlayerInteractions(e), window[t + "_checking"] && window.clearInterval(window[t + "_checking"]))
    }, 6e4)
}
...
function sendPlayRequest(e) {
    ...
    $.ajax({
        ...
        cache: "false",
        success: function(t) {
            t.success ? i.innerHTML = t.view : t.message && (e.jPlayer("stop"), alert(t.message))
        },
        failure: function() {
            alert("Error! Please try again.")
        }
...
function getPlayedUsers(e) {
    ...
    $.ajax({
        ...
        cache: "false",
        success: function(e) {
            e.success ? (i.innerHTML = e.interaction_view, r.innerHTML = e.users_view) : e.message && $('<div title="Song not Found">' + e.message + "</div>").dialog(), e.staff_message && addStaffError(e.staff_message)
        },
        failure: function() {
            alert("Error! Please try again.")
        }
...
function showPlayingSongPicture(e) {
    ...
    i.target = "_blank", i.href = n;
    var r = document.createElement("img");
    r.src = t, r.style = "width:100%;max-height:450px;";
...
function prepareDownload(e) {
    ...
    i.empty(), i.html('<center><img src="/images/squares_loading.gif" style="height:50px;" /></center>'), i.dialog({
        autoOpen: !0,
        modal: !0,
        draggable: !0,
        maxWidth: 300,
        ...
        cache: "false",
        success: function(e) {
            i.empty(), e.success ? i.append(e.view) : (i.html("Server side error - " + e.message), window.setTimeout(function() {
                i.dialog("widget").fadeTo("slow", 1e3, function() {
                    i.dialog("close")
                })
            }, 3e3), e.staff_message && addStaffError(e.staff_message))
        },
        error: function(e, t) {
            i.empty(), window.setTimeout(function() {
                i.dialog("widget").fadeTo("slow", 1e3, function() {
                    i.dialog("close")
                })
            }, 3e3), processError(e, t)
        }
    })
}
    ...
    $.ajax({
        ...
        success: function(e) {
            if (e.success) {
                ...
                t.html(e.view)
            } else e.staff_message && addStaffError(e.staff_message)
        }
    })
}
...
function addSongToPlaylist(e, t, a) {
    $.ajax({
        ...
        error: function(e, t) {
            "function" == typeof a && a(!1), processError(e, t)
        }
    })
}
...
function saveLrcText(e, t) {
    ...
    s.show(), $.ajax({
        ...
        cache: "false",
        success: function(t) {
            s.hide(), $(e).fadeIn(200), t.success ? window.location.reload(!0) : $('<div title="Error Saving">' + t.message + "</div>").dialog()
        },
        error: function(t, a) {
            s.hide(), $(e).fadeOut(200), processError(t, a, !1)
        }
    })
}
...
function checkYTVideoPlaying(e) {
    var t = ($("#youtube_player_" + e), youtubePlayers[e]);
    window[e + "_checking"] && window.clearInterval(window[e + "_checking"]), window[e + "_checking"] = window.setInterval(function() {
        t.j.playerState == YT.PlayerState.PLAYING ? sendYTVideoPlayingRequest(e) : (clearYTVideoPlayerInteractions(e), window[e + "_checking"] && window.clearInterval(window[e + "_checking"]))
    }, 15e3)
}

function sendYTVideoPlayRequest(e) {
    var t = $("#youtube_player_" + e),
        a = (youtubePlayers[e], t.attr("data-video-id")),
...
function checkVideoPlaying(e) {
    var t = e.attr("id");
    window[t + "_checking"] && window.clearInterval(window[t + "_checking"]), window[t + "_checking"] = window.setInterval(function() {
        e.data().jPlayer.status.currentTime > 0 ? sendVideoPlayingRequest(e) : (clearVideoPlayerInteractions(e), window[t + "_checking"] && window.clearInterval(window[t + "_checking"]))
    }, 15e3)
}
...
function changeLocationInputStyle() {
    ...
    "none" == e.style.display ? (e.style.display = "block", t.style.display = "none") : (e.style.display = "none", t.style.display = "block")
}
...
function refreshZone(e) {
    $.ajax({
        ...
        success: function(e, t, a) {
            zone = document.getElementById("zone"), zone.innerHTML = e, city = document.getElementById("city"), city.innerHTML = null
        },
        failure: function() {
...
function refreshCity(e) {
    $.ajax({
        ...
        cache: "false",
        success: function(e, t, a) {
            city = document.getElementById("city"), city.innerHTML = e
        },
        failure: function() {
            alert("Error Loading Zone")
        }
...
function tagBandForCareer(e) {
    ...
    document.getElementById("editable_text").textContent, t.innerHTML;
...
function tag_musician(e) {
    ...
    document.getElementById("editable_musician_text").textContent, t.innerHTML;
    t.innerHTML = e.getAttribute("name");
...
function clearSongOccasions(e) {
    ...
    t.setAttribute("data-activated", 0), a.setAttribute("data-activated", 0), n.setAttribute("data-activated", 0), e.setAttribute("data-activated", 1), t.style.display = "display:inline-block", a.style.display = "display:inline-block", n.style.display = "display:inline-block", hideSongOccasions()
}
...
function hideSongOccasions() {
    ...
    1 != e.getAttribute("data-activated") && clearSelected(e), 1 != t.getAttribute("data-activated") && clearSelected(t), 1 != a.getAttribute("data-activated") && clearSelected(a)
}
...
function refreshEntity(e) {
    null != searchTimeout && window.clearTimeout(searchTimeout), searchTimeout = window.setTimeout(function() {
        ...
        var r = e.getAttribute("data-url");
        if (r = r ? r + "/" + e.textContent : "/" + a + "/list-choice/" + e.textContent, 0 == e.textContent.length | " " == e.textContent) {
            ...
            success: function(e, a, n) {
                if (1 == e.success) {
                    ...
                    i.innerHTML = e.view, i.style.display = "block"
                } else alert(e.message)
            },
            failure: function() {
...
var albumPlayerPlaylist, linksAdded = !1,
    mySongList, geocoder, map, menuTimeout = 500,
    menuCloseTimer, lastLink;
$(document).ready(function() {
    
    }),
    function() {
        var e = function(e) {
            if (this.divID = "lyricer", this.currentcss = "lyricer-current-line", this.lineidPrefix = "lyricer-line", this.showLines = 8, this.enableDummyLines = !0, this.useTags = !0, this.clickable = !0, this.clickEventName = "lyricerclick", this.clickTimeEventName = "lyricertimeclick", this.currentLine = 0, e)
                for (var t in e) "undefined" != typeof this[t] && e.hasOwnProperty(t) && (this[t] = e[t]);
            this.useTags || (this.clickable = !1), this.lineidPrefix = this.divID + "-line", this.tags = {}, this.lrc = [], this.rangeLrc = []
        };
        e.prototype.setLrc = function(e) {
            ...
            if (this.enableDummyLines)
                for (var o = 0; o < this.showLines; o++) this.rangeLrc.push({
                    starttime: -1,
                    endtime: 0,
                    line: "&nbsp;"
                });
            for (var f = 0, p = "", o = 0; o < this.lrc.length; o++) {
                if (this.useTags)
                    if (f = this.lrc[o].starttime, p = this.lrc[o].line, this.lrc[o + 1])
                        if (this.lrc[o + 1].starttime > -1) endtime = this.lrc[o + 1].starttime;
                        else {
                            for (var y = 0; this.lrc[o + 1 + y] && this.lrc[o + 1 + y].starttime == -1 && (y += 1, !(y > 5)););
                            this.lrc[o + 1 + y] ? endtime = this.lrc[o + 1 + y].starttime : endtime = 0
                        }
                else endtime = 999.9;
                else f = this.lrc[o].starttime, p = this.lrc[o].line, endtime = 0;
                this.rangeLrc.push({
                    starttime: f,
                    endtime: endtime,
                    line: p
            ...
            this.totalLines = this.rangeLrc.length, t(this), this.move(0)
        };
        var t = function(e) {
                e.currentLine = 0;
                ...
                for (var i = 0; i < e.totalLines; i++) {
                    ...
                    r.innerHTML = e.rangeLrc[i].line, r.innerHTML || (r.innerHTML = "&nbsp"), r.setAttribute("id", e.lineidPrefix + i), e.clickable && (r.onclick = a(e, i), r.style.cursor = "pointer"), n.appendChild(r)
                }
                for (var i = 2 * e.showLines + 1; i < e.totalLines; i++) document.getElementById(e.lineidPrefix + i).style.display = "none"
            },
            a = function(e, t) {
                return function() {
                    var a = {
        ...
        e.prototype.move = function(e) {
            if (this.clickable) {
                for (var t = !1, a = 0; a < this.totalLines; a++) this.rangeLrc[a].starttime > 0 && e >= this.rangeLrc[a].starttime && (t = !0, this.currentLine = a);
        ...
        var n = function(e, t, a) {
            ...
            for (var r = 0; r < e.totalLines; r++) {
                ...
                r >= n && r <= i ? s.style.display = "block" : s.style.display = "none", r == t && a ? s.className = e.currentcss : s.className = ""
            }
        };
        ...
        var i = function(e) {
                ...
                a.className = "ul_formatter", t.appendChild(a);
                for (var n = 0; n < e.totalLines; n++) {
                    var i = document.createElement("li");
                    i.className = "li_formatter", i.innerHTML = e.rangeLrc[n].starttime > -1 ? e.rangeLrc[n].starttime.toFixed(2) : "-", i.innerHTML || (i.innerHTML = "&nbsp"), i.setAttribute("id", e.lineidPrefix + "_formatter_" + n), i.onclick = r(e, n), i.style.cursor = "pointer";
                    var s = document.getElementById(e.lineidPrefix + n);
                    i.style.height = s.clientHeight + "px", a.appendChild(i)
                }
            },
            r = function(e, t) {
                return function() {
        ...
        e.prototype.setFormatterTime = function(e, t) {
            if (this.rangeLrc[e] && !(this.rangeLrc[e].starttime < 0)) {
                ...
                if (!(e > 0 && a >= 0 && (this.rangeLrc[a].starttime <= 0 || this.rangeLrc[a].starttime > t))) {
                    ...
                    n.innerHTML = this.rangeLrc[e].starttime.toFixed(2), this.move(t)
                }
            }
        };
        var s = function(e, t) {
        ...
        e.prototype.formatNextLine = function(e) {
            ...
            for (var t in e) e[t] && ("length" == t && (e[t] = o(e[t])), this.tags[t] = e[t]);
            var a = "";
            for (var t in this.tags) a += "[" + t + ":" + this.tags[t] + "]\n";
            for (var n = 0; n < this.totalLines; n++) {
                var i = this.rangeLrc[n].starttime,
                    r = "";
                this.rangeLrc[n].starttime >= 0 && (r = "[" + o(i) + "]"), a += r + this.rangeLrc[n].line, n < this.totalLines - 1 && (a += "\n")
            }
            return a
        };
        var o = function(e) {
                var t = Math.floor(e / 60),
                    a = (e % 60).toFixed(2),
                    n = l(t);
                    // console.log("TTTTTTT",n += 0 == a ? ":0.00" : ":" + l(a));
        ...
        e.prototype.removeAllTags = function(e) {
            ...
            for (var i = 0; i < this.totalLines; i++)
                if (this.rangeLrc[i] && this.rangeLrc[i].starttime > 0) {
                    this.rangeLrc[i].starttime = 0, this.rangeLrc[i].endtime = 0;
                    var r = document.getElementById(this.lineidPrefix + "_formatter_" + i);
                    r.innerHTML = this.rangeLrc[i].starttime.toFixed(2)
                } this.currentLine = 0, n(this, this.currentLine)
        }, e.prototype.applyOffset = function(e) {
            for (var t = 0; t < this.totalLines; t++)
                if (this.rangeLrc[t] && this.rangeLrc[t].starttime > 0) {
                    if (this.rangeLrc[t].starttime + e < 0) return;
                    this.rangeLrc[t].starttime = this.rangeLrc[t].starttime + e, this.rangeLrc[t].endtime = this.rangeLrc[t].endtime + e;
    ...
    Prism = function() {
        var e = /\blang(?:uage)?-(\w+)\b/i,
            ...
            a = _self.Prism = {
                ...
                languages: {
                    ...
                    DFS: function(e, t, n, i) {
                        i = i || {};
                        for (var r in e) e.hasOwnProperty(r) && (t.call(e, r, e[r], n || r), "Object" !== a.util.type(e[r]) || i[a.util.objId(e[r])] ? "Array" !== a.util.type(e[r]) || i[a.util.objId(e[r])] || (i[a.util.objId(e[r])] = !0, a.languages.DFS(e[r], t, r, i)) : (i[a.util.objId(e[r])] = !0, a.languages.DFS(e[r], t, null, i)))
                    }
                },
                plugins: {},
                ...
                highlightElement: function(t, n, i) {
                    for (var r, s, o = t; o && !e.test(o.className);) o = o.parentNode;
                    o && (r = (o.className.match(e) || [, ""])[1].toLowerCase(), s = a.languages[r]), t.className = t.className.replace(e, "").replace(/\s+/g, " ") + " language-" + r, o = t.parentNode, /pre/i.test(o.nodeName) && (o.className = o.className.replace(e, "").replace(/\s+/g, " ") + " language-" + r);
                    var l = t.textContent,
                        c = {
                            element: t,
                            language: r,
                    ...
                    if (a.hooks.run("before-highlight", c), n && _self.Worker) {
                    ...
                    } else c.highlightedCode = a.highlight(c.code, c.grammar, c.language), a.hooks.run("before-insert", c), c.element.innerHTML = c.highlightedCode, i && i.call(t), a.hooks.run("after-highlight", c), a.hooks.run("complete", c)
                },
                    ...
                    for (var c in n)
                        if (n.hasOwnProperty(c) && n[c]) {
                            ...
                            for (var u = 0; u < d.length; ++u) {
                                ...
                                g = g.pattern || g;
                                for (var _ = i, b = r; _ < t.length; b += t[_].length, ++_) {
                                    var E = t[_];
                                    ...
                                    if (!(E instanceof l)) {
                                        ...
                                        if (!w && p && _ != t.length - 1) {
                                            ...
                                            for (var T = w.index + (f ? w[1].length : 0), I = w.index + w[0].length, k = _, L = b, $ = t.length; $ > k && (I > L || !t[k].type && !t[k - 1].greedy); ++k) L += t[k].length, T >= L && (++_, b = L);
                                            if (t[_] instanceof l || t[k - 1].greedy) continue;
                                            x = k - _, E = e.slice(b, L), w.index -= b
                                        }
                                        if (w) {
                                            f && (y = w[1].length);
                                            var T = w.index + y,
                                                ...
                                                P = E.slice(I),
                                                S = [_, x];
                                            A && (++_, b += A.length, S.push(A));
                                            var B = new l(c, m ? a.tokenize(w, m) : w, h, w, p);
                                            if (S.push(B), P && S.push(P), Array.prototype.splice.apply(t, S), 1 != x && a.matchGrammar(e, t, n, _, b, !0, c), s) break
                                        } else if (s) break
                                    }
                                }
                            }
            ...
            n = a.Token = function(e, t, a, n, i) {
                this.type = e, this.content = t, this.alias = a, this.length = 0 | (n || "").length, this.greedy = !!i
            };
        if (n.stringify = function(e, t, i) {
            ...
            var t = JSON.parse(e.data),
                ...
                i = t.code,
                r = t.immediateClose;
            _self.postMessage(a.highlight(i, a.languages[n], n)), r && _self.close()
        }, !1), _self.Prism) : _self.Prism;
        var i = document.currentScript || [].slice.call(document.getElementsByTagName("script")).pop();
        return i && (a.filename = i.src, a.manual || i.hasAttribute("data-manual") || ("loading" !== document.readyState ? window.requestAnimationFrame ? window.requestAnimationFrame(a.highlightAll) : window.setTimeout(a.highlightAll, 16) : document.addEventListener("DOMContentLoaded", a.highlightAll))), _self.Prism
    }();
